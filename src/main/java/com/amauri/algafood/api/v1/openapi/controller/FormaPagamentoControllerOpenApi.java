...
public interface FormaPagamentoControllerOpenApi {
	...
	ResponseEntity<FormaPagamentoModel> buscar(@Parameter(description = "ID de uma forma de pagamento",
	...
	ResponseEntity<Void> excluir(@Parameter(description = "ID de uma forma de pagamento", example = "1", required = true)
								 Long formaPagamentoId);
